    ...
    return(
        ...
        <header class="ps-header ps-header--3">
            ...
            <div class="ps-header__middle">
                <div class="container">
                    <div class="ps-logo"><a href="index.html"/> <img src="img/logo.png" alt=""/><img class="sticky-logo" src="img/sticky-logo.png" alt=""/></div><a class="ps-menu--sticky" href="#"><i class="fa fa-bars"></i></a>
            ...
            <div class="ps-navigation__left">
                        <nav class="ps-main-menu">
                            <ul class="menu">
                                ...
                                <li class="has-mega-menu"><Link to="/Contact">Contact us</Link></li>
